module Crawlers
  module Cookpad
    class Recipe
      ...
      def crawl_recipe_page(url:)
        source_uid = Crawlers::Cookpad::Recipe.get_recipe_id_from_url(url: url)
        ...
        # 保存
        Crawlers::Cookpad::Recipe.save_crawled_recipe(source_uid: source_uid, url: url, title: title, image_url: image_url, materials: materials)
      end
      ...
      def self.get_recipe(url:)
        crawler = Crawlers::Cookpad::Recipe.new
        crawler.crawl_recipe_page(url: url)
      end
      ...
      def self.save_crawled_recipe(source_uid:, url:, title:, image_url:, materials:)
